const gifStages = [
    ...
    "https://media1.tenor.com/m/_HmRvzll_ZEAAAAC/dear-slim-muscles.gif",             // 1 confused
...
const noMessages = [
    ...
    "Sure kana Bebi? 🤔",
    "Laluvs please... 🥺",
    "Isa pang no, Magmukmok na ang ferson...",
    "Nautot nako sa lungkot... 😢",
    "Please??? 💔",
    "SIGE GANYAN 😠...",
    "Last chance! 😭",
    "Hulihin moko bleh 😜"
...
const yesTeasePokes = [
    "Magpakipot ka naman daw a... 😏",
    "Sige naaa,no muna... makisama ka 👀",
    "PAPANSIN 😈",
    "click no na, dali na 😏"
]
